...
func TestSigner(t *testing.T) {
	...
	if int(OverheatLockCounter) != len(inputData) ||
		...
		t.Logf("OverheatLockCounter: %d", OverheatLockCounter)
		t.Logf("OverheatUnlockCounter: %d", OverheatUnlockCounter)
		t.Logf("DataSignerMd5Counter: %d", DataSignerMd5Counter)
		t.Logf("DataSignerCrc32Counter: %d", DataSignerCrc32Counter)
